...
<body>
   <div class="logo-cont">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') { // Checking if both email and password are set
        ...
        try {
            $lgnQry = "SELECT * FROM user_credentials WHERE Email ='$Email' and User_Type='Student'";
            ...
            if (!$result) {
                ...
                if (password_verify($Pwd, $pwd)) {
                    ...
                    Swal.fire({
                        ...
                        window.location.href = './Studashboard.php'; // This line might be the source of the issue
                    });
